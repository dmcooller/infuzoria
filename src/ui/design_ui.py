...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rightSidebarLayout.addWidget(self.checkBoxSaveLines, 17, 1, 1, 2)
        ...
        self.rightSidebarLayout.addWidget(self.label_5, 14, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.lineEditFovUm.sizePolicy().hasHeightForWidth())
        self.lineEditFovUm.setSizePolicy(sizePolicy2)
        ...
        self.rightSidebarLayout.addWidget(self.lineEditFovUm, 14, 1, 1, 2)
        ...
        self.rightSidebarLayout.addWidget(self.line_4, 16, 0, 1, 3)
        ...
        self.rightSidebarLayout.addWidget(self.checkBoxSavePoints, 17, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.lineEditTotalDistance.sizePolicy().hasHeightForWidth())
        self.lineEditTotalDistance.setSizePolicy(sizePolicy2)
        ...
        self.rightSidebarLayout.addWidget(self.lineEditTotalDistance, 15, 1, 1, 2)
        ...
        sizePolicy2.setHeightForWidth(self.lineEditFovPx.sizePolicy().hasHeightForWidth())
        self.lineEditFovPx.setSizePolicy(sizePolicy2)
        ...
        self.rightSidebarLayout.addWidget(self.label_2, 15, 0, 1, 1)
        ...
        self.rightSidebarLayout.addItem(self.verticalSpacer, 19, 0, 1, 3)
        ...
        self.rightSidebarLayout.addWidget(self.checkBoxSaveDistance, 18, 0, 1, 3)
